...
string(JSON family GET "${provenance}" family)
if(NOT family STREQUAL "0.73.x")
  message(FATAL_ERROR "provenance family must be 0.73.x, got '${family}'")
endif()
string(JSON js_visible GET "${provenance}" jsVisibleReactNativeVersion)
if(NOT js_visible STREQUAL "0.73.10")
  message(FATAL_ERROR
    "provenance jsVisibleReactNativeVersion must be 0.73.10, got '${js_visible}'")
endif()
string(JSON format GET "${provenance}" build format)
if(NOT format STREQUAL "metro-source" AND NOT format STREQUAL "hermesc-hbc")
  message(FATAL_ERROR
    "provenance build.format must be metro-source or hermesc-hbc, got '${format}'")
endif()
...
string(REGEX MATCH "(^|\n)(\\{[^\n]*\"host\":\"react-native-simulator\"[^\n]*)"
  _metrics_match "${output}")
if(CMAKE_MATCH_2)
  set(_metrics_line "${CMAKE_MATCH_2}")
endif()
